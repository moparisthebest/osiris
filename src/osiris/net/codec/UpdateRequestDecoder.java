...
/**
 * A decoder for an update request.
 * 
 * @author Blake
 * 
 */
@ChannelPipelineCoverage("all")
public class UpdateRequestDecoder extends FrameDecoder {
	...
	protected Object decode(ChannelHandlerContext ctx, Channel channel, ChannelBuffer in) throws Exception {
		if (in.readableBytes() % 4 == 0) {
			...
			Packet packet = new Packet(new PacketHeader(257, buffer.writerIndex()), buffer);
			return packet;
		}
		return null;
	}
